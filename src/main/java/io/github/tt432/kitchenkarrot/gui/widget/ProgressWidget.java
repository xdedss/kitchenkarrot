...
public class ProgressWidget extends TooltipWidget {
    ...
    public void render(PoseStack poseStack, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        if (vertical) {
            ...
            screen.blit(poseStack, getX(), trueY, texX, trueTexY, width, trueHeight);
        } else {
            var trueWidth = width - (int) (this.width * p);
            screen.blit(poseStack, getX(), getY(), texX, texY, trueWidth, this.height);
        }
    ...
    // @Override
    // public void render(PoseStack poseStack, int pMouseX, int pMouseY, float
    // pPartialTick) {
    // if (!visible) {
    // return;
    // }
