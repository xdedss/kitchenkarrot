...
public class ModItems {
    ...
    public static final RegistryObject<Item> BEEF_IN_DRIPLEAF = ITEMS.register("beef_in_dripleaf", () -> new FoodItem(12, 16).setIndex(25));
    public static final RegistryObject<Item> SMALL_BEEF_IN_DRIPLEAF = ITEMS.register("small_beef_in_dripleaf", () -> new FoodItem(6, 8).setIndex(26));
    public static final RegistryObject<Item> BAMBOO_POTATO = ITEMS.register("bamboo_potato", () -> new FoodItem(8, 8).setIndex(27));
    public static final RegistryObject<Item> PICKLED_SEA_PICKLES = ITEMS.register("pickled_sea_pickles", () -> new FoodItem(3, 2).setIndex(28));
    ...
    public static final RegistryObject<Item> BEETROOT_CREPE = ITEMS.register("beetroot_crepe", () -> new FoodItem(10, 9.6F).setIndex(31));
    public static final RegistryObject<Item> CHINESE_CREPE = ITEMS.register("chinese_crepe", () -> new FoodItem(10, 9.6F).setIndex(32));
    ...
    public static final RegistryObject<Item> GRILLED_FISH_AND_CACTUS = ITEMS.register("grilled_fish_and_cactus", () -> new FoodItem(8, 6.4F).setIndex(35));
    public static final RegistryObject<Item> FLOWER_CAKE = ITEMS.register("flower_cake", () -> new FoodItem(6, 4.8F).setIndex(36));
    public static final RegistryObject<Item> PILLAGER_PIE = ITEMS.register("pillager_pie", () -> new FoodItem(8, 4.8F, EffectEntry.of(MobEffects.BAD_OMEN, 600, 1)).setIndex(37));
    ...
    public static final RegistryObject<Item> SWEET_LOAF = ITEMS.register("sweet_loaf", () -> new FoodItem(0, 0).setIndex(74));
    ...
    public static final RegistryObject<Item> SIRLOIN_STEAK = ITEMS.register("sirloin_steak", () -> new FoodItem(12, 14.4F).setIndex(76));
    ...
    public static final RegistryObject<Item> FRIES = ITEMS.register("fries", () -> new FoodItem(7, 10.8F).setIndex(80));
    public static final RegistryObject<Item> DRUMSTICK = ITEMS.register("drumstick", () -> new FoodItem(9, 12.8F).setIndex(81));
    ...
    public static final RegistryObject<Item> MEAD = ITEMS.register("mead", () -> new DrinkItem(0, 0F).setIndex(116));
    public static final RegistryObject<Item> RUM = ITEMS.register("rum", () -> new DrinkItem(0, 0F, EffectEntry.of(MobEffects.DOLPHINS_GRACE, 300, 1)).setIndex(117));
    public static final RegistryObject<Item> VODKA = ITEMS.register("vodka", () -> new DrinkItem(0, 0F, EffectEntry.of(MobEffects.DAMAGE_BOOST, 300, 1)).setIndex(118));

    public static final RegistryObject<Item> KELP_WITH_SUNFLOWER_SEED = ITEMS.register("kelp_with_sunflower_seed", () -> new SnackItem(2, 1, 12).setIndex(21));
    ...
    public static final RegistryObject<Item> TWISTING_SODA = ITEMS.register("twisting_soda", () -> new SnackDrinkItem(0, 0F, 24, EffectEntry.of(MobEffects.ABSORPTION, 60, 1)).setIndex(121));
    public static final RegistryObject<Item> DANDELION_COKE = ITEMS.register("dandelion_coke", () -> new SnackDrinkItem(0, 0F, 24, EffectEntry.of(MobEffects.MOVEMENT_SPEED, 180, 2,1), EffectEntry.of(MobEffects.DIG_SPEED, 180,1)).setIndex(122));
    public static final RegistryObject<Item> CORAL_COKE = ITEMS.register("coral_coke", () -> new SnackDrinkItem(0, 0F, 24, EffectEntry.of(MobEffects.MOVEMENT_SPEED, 180, 1), EffectEntry.of(MobEffects.DIG_SPEED, 180, 2, 1)).setIndex(123));
    ...
    public static final RegistryObject<Item> FISHERMENS_DELIGHT = ITEMS.register("fishermens_delight", () -> new BowlFoodItem(10, 10.4F).setIndex(38));
    ...
    public static final RegistryObject<Item> CURRY_UDON = ITEMS.register("curry_udon", () -> new CurryUdonItem(10, 14.4F).setIndex(84));
    ...
    public static final RegistryObject<Item> RAW_BEEF_IN_DRIPLEAF = ITEMS.register("raw_beef_in_dripleaf", () -> new IndexItem(defaultProperties(),24));
