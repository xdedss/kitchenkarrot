...
public class ModMenuTypes {
        ...
        public static final RegistryObject<MenuType<AirCompressorMenu>> AIR_COMPRESSOR = MENUS
                        .register("air_compressor", () -> from(AirCompressorMenu::new));

        public static final RegistryObject<MenuType<BrewingBarrelMenu>> BREWING_BARREL = MENUS
                        .register("brewing_barrel", () -> from(BrewingBarrelMenu::new));
        public static final RegistryObject<MenuType<ShakerMenu>> SHAKER = MENUS.register("shaker",
                        () -> new MenuType<>(ShakerMenu::new, FeatureFlags.VANILLA_SET));
        ...
        private static <M extends AbstractContainerMenu, T extends BlockEntity> MenuType<M> from(
                ...
                return IForgeMenuType.create((id, inv, data) -> creator.create(id, inv,
                                (T) inv.player.getLevel().getBlockEntity(data.readBlockPos())));
        }
}
